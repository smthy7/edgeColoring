...
- **Gespiegelte Platzierung (Spiegelung auf linken Seiten):** Bei Vorderschnitt, Kopfschnitt und Fußschnitt wird der fertig platzierte Rahmen auf der linken Seite (Verso) nachträglich mit der InDesign-Spiegelfunktion an gleicher Position horizontal gespiegelt, sodass Bild auf Bild („Illu auf Illu“) ein stimmiges Gesamtbild ergibt.
...
- **Linke Seite (Verso):** Der Farbschnitt erstreckt sich von der linken Außenkante bis zur rechten Seitenkante (Bund) und geht nicht darüber hinaus. Bei Vorderschnitt, Kopfschnitt und Fußschnitt wird das generierte Objekt auf der linken Seite im Anschluss horizontal an gleicher Position gespiegelt.
